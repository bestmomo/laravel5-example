<html>
<head>
<title>Docs For Class WideImage_Font_TTF</title>
...
<h1>Class: WideImage_Font_TTF</h1>
Source Location: /Font/TTF.php<br /><br />
...
<pre></pre><br />
<div class="description">TTF font support class</div><br /><br />
...
<ul>
    <li><a href="../WideImage/WideImage_Font_TTF.html#var$color">$color</a></li>
    <li><a href="../WideImage/WideImage_Font_TTF.html#var$face">$face</a></li>
    <li><a href="../WideImage/WideImage_Font_TTF.html#var$size">$size</a></li>
  </ul>
</td>
...
<ul>
    <li><a href="../WideImage/WideImage_Font_TTF.html#method__construct">__construct</a></li>
    <li><a href="../WideImage/WideImage_Font_TTF.html#methodwriteText">writeText</a></li>
  </ul>
</td>
...
<div class="tags">
[line 30]<br />
TTF font support class<br /><br /></div><br /><br />
...
<div class="tags">
	<a name="var$color"></a>
	<p></p>
	<h4>$color = <span class="value"></span></h4>
	<p>[line 34]</p>
  <br /><br />
<h4>Tags:</h4>
<div class="tags">
<table border="0" cellspacing="0" cellpadding="0">
  ...
  <table border="0" cellspacing="0" cellpadding="0">
	...
	<a name="var$face"></a>
	<p></p>
	<h4>$face = <span class="value"></span></h4>
	<p>[line 32]</p>
  <br /><br />
<h4>Tags:</h4>
<div class="tags">
<table border="0" cellspacing="0" cellpadding="0">
  ...
  <table border="0" cellspacing="0" cellpadding="0">
	...
	<a name="var$size"></a>
	<p></p>
	<h4>$size = <span class="value"></span></h4>
	<p>[line 33]</p>
  <br /><br />
<h4>Tags:</h4>
<div class="tags">
...
<div class="tags">
  ...
  <hr />
	...
	<h3>constructor __construct <span class="smalllinenumber">[line 36]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>WideImage_Font_TTF __construct(
...
$color)</code>
  ...
  <hr />
	<a name="methodwriteText"></a>
	<h3>method writeText <span class="smalllinenumber">[line 52]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void writeText(
<a href="../WideImage/WideImage_Image.html">WideImage_Image</a>
$image, mixed
$x, mixed
$y, string
$text, [int
$angle = 0])</code>
		...
		Writes text onto an image<br /><br /><br /><br />
    ...
    <table border="0" cellspacing="0" cellpadding="0">
          <tr>
        <td class="type"><a href="../WideImage/WideImage_Image.html">WideImage_Image</a>&nbsp;&nbsp;</td>
        <td><b>$image</b>&nbsp;&nbsp;</td>
        <td></td>
      </tr>
          <tr>
